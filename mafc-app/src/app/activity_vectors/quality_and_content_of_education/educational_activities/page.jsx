...
export const metadata = generateStaticPageMeta('/activity_vectors/quality_and_content_of_education/educational_activities');

const EducationalActivities= async()=> {

      const pageRoute = '/api/educational-activities-page';
